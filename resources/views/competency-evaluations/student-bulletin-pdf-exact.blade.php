...
<body>
    <div class="bulletin-container">
        ...
        <!-- Tableau des compétences - Structure exacte de l'image -->
        <table class="competency-table">
            <thead>
                <tr>
                    ...
                    <th colspan="3" style="background-color: #e8f4fd;">Compétences transversales</th>
                    <!-- EDM & EA8 -->
                    <th colspan="3" style="background-color: #fff2cc;">EDM & EA8</th>
                    <!-- Français -->
                ...
                <tr>
                    <!-- Compétences transversales -->
                    <th style="background-color: #e8f4fd;">Autonomie et Initiative</th>
                    <th style="background-color: #e8f4fd;">Travail en équipe</th>
                    <th style="background-color: #e8f4fd;">Communication</th>
                    ...
                    <th style="background-color: #f8cecc;">Résolution de problèmes</th>
                </tr>
                <tr>
                    <th></th>
                    <th></th>
                    <!-- Critères pour chaque compétence -->
                    @for($i = 0; $i < 12; $i++)
                        <th style="font-size: 7px;">C1</th>
                        <th style="font-size: 7px;">C2</th>
                        <th style="font-size: 7px;">C3</th>
                        <th style="font-size: 7px;">C4</th>
                    @endfor
                </tr>
            </thead>
            <tbody>
                    ...
                    @for($p = 1; $p <= 5; $p++)
                        ...
                        <tr>
                            ...
                            @for($i = 0; $i < 12; $i++)
                                ...
                                @endphp
                                <td colspan="4" class="mastery-{{ $mastery }}">
                        ...
                        <tr>
                            ...
                            <td colspan="12" class="mastery-partielle">PART</td>
                        </tr>
                    @endfor
                    
                    <!-- Profil de sortie -->
                    <tr>
                        <td class="palier-row">Profil de sortie</td>
                        <td>Nombre de points du critère</td>
                        @for($i = 0; $i < 12; $i++)
                            <td>5</td>
                            <td>5</td>
