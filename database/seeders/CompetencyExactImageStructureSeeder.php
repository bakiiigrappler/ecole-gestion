...
class CompetencyExactImageStructureSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        foreach ($competencies as $competencyData) {
            ...
            // Créer 3 critères (C1, C2, C3) pour chaque compétence principale
            for ($i = 1; $i <= 3; $i++) {
        ...
        // Créer les compétences transversales pour le profil de sortie
